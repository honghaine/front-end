    ...
    return (
        <div>
            ...
            <div className='flex'>
                ...
                <div className="Frame13 w-[1530px] h-[683.53px] p-10 bg-white rounded-[20px] shadow flex-col justify-start items-start gap-8 inline-flex">
                    ...
                    <div className="Frame15 self-stretch justify-start items-end gap-5 inline-flex">
                        ...
                        <div className="Frame17 w-[470px] h-[82px] flex-col justify-center items-start gap-2 inline-flex">
